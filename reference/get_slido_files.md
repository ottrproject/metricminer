...
must be saved as googlesheets and cannot be xlsx. The scope it uses is
to \`view and manage your Drive files' the \`See, edit, create, and
delete all your Google Sheets spreadsheets.\` However, the user will
need to authorize their google account twice (once for googledrive and
once for googlesheets) If you don't check these boxes on the OAuth
screens, this function won't work.
